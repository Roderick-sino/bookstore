...
<h1 style="text-align: center; line-height: 30px;">bookstore图书销售系统后台管理</h1>
<div style="line-height: 10px;">
	<span>管理员：${sessionScope.admin.adminname }</span>
	<a target="_top" href="<c:url value='/AdminServlet?method=out'/>">退出</a>
	<span style="padding-left:50px;">
		...
		<a href="<c:url value='/admin/AdminUserServlet?method=load'/>">用户管理</a>
		<a href="<c:url value='/admin/AdminCommentServlet?method=findAll'/>">评论管理</a>
	</span>
</div>
  </body>
</html>